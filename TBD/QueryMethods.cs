namespace TBD
{
    public class QueryMethods
    {
        ...
        public static string GenerateUpdateTransaction(string isolationLevel, string fatura_id, string cliente_id, string nome, string morada,
            string fatura_id_old, string cliente_id_old, string nome_old, string morada_old, string user_id, string terminal_id,
            string terminal_name)
        {
            string tran;
            tran  = "SET TRANSACTION ISOLATION LEVEL " + isolationLevel + " ";
            tran += "DECLARE @dateBegin DATETIME; ";
            tran += "SET @dateBegin = datetime('now'); ";
            ...
            tran += "(" + COLUMN_LOG_EVENT_TYPE + ", " + COLUMN_LOG_FATURA_ID_OLD + ", " + COLUMN_LOG_CLIENT_ID_OLD +
                ...
                ", " + COLUMN_LOG_USER_ID + ", " + COLUMN_LOG_TERMINAL_ID + ", " + COLUMN_LOG_TERMINAL_NAME +
                ", " + COLUMN_LOG_START_TIME + ", " + COLUMN_LOG_END_TIME + ") ";
            tran += "VALUES (U," + fatura_id_old + ", " + cliente_id_old + ", " + nome_old + ", " + morada_old +
                ", " + fatura_id + ", " + cliente_id + ", " + nome + ", " + morada + ", " + user_id + ", " + terminal_id +
                ", " + terminal_name + ", @dateBegin" + ", datetime('now));";


            return tran;
        }

        public static string GenerateDeleteTransaction(string isolationLevel, string fatura_id, string cliente_id, string nome, string morada,
            string user_id, string terminal_id, string terminal_name)
        {
            string tran;
            tran  = "SET TRANSACTION ISOLATION LEVEL " + isolationLevel + " ";
            tran += "DECLARE @dateBegin DATETIME; ";
            ...
            string terminal_name)
        {
            ...
            tran += "(" + COLUMN_LOG_EVENT_TYPE + ", " + COLUMN_LOG_FATURA_ID_OLD + ", " + COLUMN_LOG_CLIENT_ID_OLD +
                ...
                ", " + COLUMN_LOG_USER_ID + ", " + COLUMN_LOG_TERMINAL_ID + ", " + COLUMN_LOG_TERMINAL_NAME +
                ", " + COLUMN_LOG_START_TIME + ", " + COLUMN_LOG_END_TIME + ") ";
            tran += "VALUES (I," + fatura_id_old + ", " + cliente_id_old + ", " + nome_old + ", " + morada_old +
                ", " + fatura_id + ", " + cliente_id + ", " + nome + ", " + morada + ", " + user_id + ", " + terminal_id +
                ", " + terminal_name + ", @dateBegin" + ", datetime('now));";
